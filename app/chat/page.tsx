...
export default function Home() {
  ...
  const InfoCard: React.ReactElement = (
    <section className="p-2 md:p-8 w-full max-h-[85%] overflow-hidden bg-transparent">
      <div className="text-center mb-12">
        ...
        <p className="text-2xl my-4 font-regular text-[#747474] max-[930px]:text-base max-[600px]:text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-base">
        <button
          ...
          className="px-3 py-8 rounded-lg border border-[#2A2F3C] text-[#E8EAED] hover:bg-[#2A2F3C] transition-colors max-[600px]:text-xs"
          style={{
  ...
  return (
    <section className="flex h-screen bg-transparent bg-cover bg-no-repeat bg-center">
      <aside className="w-1/4 bg-[#121212] p-4 overflow-y-auto border-r border-[#2A2F3C] bg-opacity-70">
